...
public class DoodleView extends View {
    ...
    private Bitmap bitmap; // drawing area for displaying/saving
    private Canvas bitmapCanvas; // used to draw on the bitmap
    private final Paint paintScreen; // used to draw bitmap onto screen
    private final Paint paintLine; // used to draw lines on the bitmap
    ...
    public DoodleView(Context context, AttributeSet attrs) {
        ...
        paintLine.setColor(Color.BLACK); // default color
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        // determine whether touch started/ended/moving
    ...
    private void touchStarted(float x, float y, int lineID) {
        ...
        if (pathMap.containsKey(lineID)) {
            ...
            path.reset(); // resets Path because a new touch has started
            point = previousPointMap.get(lineID); // get a Path's last point
        } else {
            path = new Path();
    ...
    private void touchMoved(MotionEvent event) {
        ...
        for (int i = 0; i < event.getPointerCount(); i++) {
            ...
            if (pathMap.containsKey(pointerID)) {
                // get the new coords for the pointer
                ...
                // if the distance is sig. enough to matter
